...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(PUBLIC_THEME); ?>/css/layoutmain.css">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="login-header" style="margin-left: 300px">
                ...
                <div class="" style="float: left !important;">
                    <?php if(!empty(isset($_SESSION[AUTH]))): ?>
                        <a href="<?php echo e(BASE_URL . "logout"); ?>" class="text-decoration">Đăng xuất</a> / <a href="<?php echo e(BASE_URL . "admin"); ?>" class="text-decoration">Quản Trị</a>
                    <?php else: ?>
                        <a href="<?php echo e(BASE_URL . "login"); ?>" class="text-decoration">Đăng Nhập</a>
                    <?php endif; ?>
...
<div class="footer-banner">
    <img width="100%" height="200" src="<?php echo e(THEME_ASSET_URL); ?>/fotten.PNG" alt=""/>
</div>
...
</html><?php /**PATH C:\xampp\htdocs\php2\asm\app\views/layouts/main.blade.php ENDPATH**/ ?>